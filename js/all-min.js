...
// تعديل الدالة لتقرأ قيمة الطبعة المختارة
...
// تعديل الدالة لتخزين اسم الطبعة في السلة
function saveToCart(e, t, o, a, n, p = "Default") {
  let s = JSON.parse(localStorage.getItem("cart")) || [],
    l = { img: e, nameKey: t, name: o, price: a, size: n, print: p, quantity: 1 },
    c = s.find((e) => e.img === l.img && e.size === l.size && e.print === l.print);
